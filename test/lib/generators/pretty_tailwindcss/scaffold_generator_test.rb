require "test_helper"
require "generators/pretty_tailwindcss/scaffold/scaffold_generator"

class PrettyTailwindcss::Generators::ScaffoldGeneratorTest < Rails::Generators::TestCase
  tests PrettyTailwindcss::Generators::ScaffoldGenerator
